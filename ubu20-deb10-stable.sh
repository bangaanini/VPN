...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/fredoomX7/genZ/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/bangaanini/VPN/main/Regist"
# USERNAME
rm -f /usr/bin/user
...
TIMES="100"
CHATID="-1002396876898"
KEY="7658017940:AAFnO8Qqh_hXGJ7G0zhAuow8e2KiTG-KT4I"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6285163692509"}]]}' 
...
wget -q https://raw.githubusercontent.com/fredoomX7/genZ/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
port 587
auth on
user rokeroke41@gmail.com
from rokeroke41@gmail.com
password xcbg ryvv vcah ruyh 
logfile ~/.msmtp.log
EOF
